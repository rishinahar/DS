...
public class ArithmeticProgressionMissingElementFinder {
	...
	public static List<Integer> readInput( InputStream stream ) {
		System.out.println(" Please enter length of arithmetic sequence");
		Scanner scanner = new Scanner( stream );
		
		int length = scanner.nextInt();
		List<Integer> sequence = new ArrayList<>( length );
		
		System.out.println(" Please enter the arithmetic sequence");
